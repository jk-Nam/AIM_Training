...
public class Weapon : MonoBehaviour
{
	...
	// Accuracy
	public float accuracy = 100.0f;						// How accurate this weapon is on a scale of 0 to 100
	...
	public float accuracyRecoverRate = 1.0f;			// How quickly the accuracy recovers after each shot (value between 0 and 1)
